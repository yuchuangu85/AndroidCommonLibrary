...
public final class PipeTest {
    ...
    @Test
    public void foldWritesPipeContentsToSink() throws IOException {
        final Pipe pipe = new Pipe(128);
    ...
    @Test
    public void foldUnblocksBlockedWrite() throws IOException, InterruptedException {
    ...
    @Test
    public void accessSourceAfterFold() throws IOException {
        final Pipe pipe = new Pipe(100L);
    ...
    @Test
    public void foldingTwiceThrows() throws IOException {
        final Pipe pipe = new Pipe(128);
        pipe.fold(new Buffer());
        try {
            pipe.fold(new Buffer());
    ...
    @Test
    public void sinkWriteThrowsIOExceptionUnblockBlockedWriter()
    ...
    @Test
    public void foldHoldsNoLocksWhenForwardingWrites() throws IOException {
        final Pipe pipe = new Pipe(4);
    ...
    @Test
    public void honorsUnderlyingTimeoutOnWritingWhenItIsSmaller() throws IOException {
        final Pipe pipe = new Pipe(4);
    ...
    @Test
    public void honorsUnderlyingSinkDeadlineOnFlushingWhenItIsSmaller() throws IOException {
        final Pipe pipe = new Pipe(4);
    ...
    @Test
    public void honorsUnderlyingSinkDeadlineOnClosingWhenPipeSinkHasNoDeadline()
            throws IOException {
     ...
     */
    @Test
    public void foldFlushesWhenThereIsFoldedData() throws IOException {
    ...
    @Test
    public void foldDoesNotFlushWhenThereIsNoFoldedData() throws IOException {
        Pipe pipe = new Pipe(128);
    ...
    @Test
    public void foldingClosesUnderlyingSinkWhenPipeSinkIsClose() throws IOException {
        final Pipe pipe = new Pipe(128);
