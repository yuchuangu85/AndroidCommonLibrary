...
public final class OptionsTest {
     ...
     */
    @Test
    public void optionOrderTakesPrecedence() {
        assertSelect("abcdefg", 0, "abc", "abcdef");
        assertSelect("abcdefg", 0, "abcdef", "abc");
    }

    @Test
    public void simpleOptionsTrie() {
    ...
    @Test
    public void realisticOptionsTrie() {
    ...
    @Test
    public void emptyStringInOptionsTrie() {
        try {
            utf8Options("");
            fail();
    ...
    @Test
    public void multipleIdenticalValues() {
        try {
            utf8Options("abc", "abc");
            fail();
        } catch (IllegalArgumentException expected) {
    ...
    @Test
    public void prefixesAreStripped() {
    ...
    @Test
    public void multiplePrefixesAreStripped() {
