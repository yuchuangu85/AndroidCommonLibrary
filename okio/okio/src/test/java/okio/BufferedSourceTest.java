...
public final class BufferedSourceTest {
    ...
    @Test
    public void peekMultiple() throws IOException {
        sink.writeUtf8("abcdefghi");
        sink.emit();
    ...
    @Test
    public void peekLarge() throws IOException {
        sink.writeUtf8("abcdef");
    ...
    @Test
    public void peekInvalid() throws IOException {
        sink.writeUtf8("abcdefghi");
        sink.emit();
    ...
    @Test
    public void peekSegmentThenInvalid() throws IOException {
        sink.writeUtf8("abc");
    ...
    @Test
    public void peekDoesntReadTooMuch() throws IOException {
    ...
    @Test
    public void rangeEqualsArgumentValidation() throws IOException {
    ...
    @Test
    public void readNioBuffer() throws Exception {
    ...
    @Test
    public void readLargeNioBufferOnlyReadsOneSegment() throws Exception {
