...
public final class BufferCursorTest {
    enum BufferFactory {
        ...
        SMALL_SEGMENTED_BUFFER {
            @Override
            Buffer newBuffer() throws Exception {
    ...
    @Test
    public void accessSegmentBySegment() throws Exception {
    ...
    @Test
    public void seekToNegativeOneSeeksBeforeFirstSegment() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        try (UnsafeCursor cursor = buffer.readUnsafe()) {
            cursor.seek(-1L);
    ...
    @Test
    public void accessByteByByte() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        try (UnsafeCursor cursor = buffer.readUnsafe()) {
    ...
    @Test
    public void accessByteByByteReverse() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        try (UnsafeCursor cursor = buffer.readUnsafe()) {
            byte[] actual = new byte[(int) buffer.size()];
    ...
    @Test
    public void accessByteByByteAlwaysResettingToZero() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        try (UnsafeCursor cursor = buffer.readUnsafe()) {
            byte[] actual = new byte[(int) buffer.size()];
            for (int i = 0; i < buffer.size(); i++) {
    ...
    @Test
    public void segmentBySegmentNavigation() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
    ...
    @Test
    public void seekWithinSegment() throws Exception {
    ...
    @Test
    public void doubleAcquire() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        try (UnsafeCursor cursor = buffer.readUnsafe()) {
            buffer.readUnsafe(cursor);
            fail();
    ...
    @Test
    public void releaseWithoutAcquire() throws Exception {
        UnsafeCursor cursor = new UnsafeCursor();
        try {
            cursor.close();
            fail();
    ...
    @Test
    public void enlargeByManySegments() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        long originalSize = buffer.size();
    ...
    @Test
    public void resizeNotAcquired() throws Exception {
        UnsafeCursor cursor = new UnsafeCursor();
        try {
    ...
    @Test
    public void expandNotAcquired() throws Exception {
        UnsafeCursor cursor = new UnsafeCursor();
        try {
    ...
    @Test
    public void resizeAcquiredReadOnly() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
    ...
    @Test
    public void expandAcquiredReadOnly() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
    ...
    @Test
    public void shrinkByManySegments() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
    ...
    @Test
    public void shrinkAdjustOffset() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
    ...
    @Test
    public void resizeToSameSizeSeeksToEnd() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        long originalSize = buffer.size();
    ...
    @Test
    public void resizeEnlargeMovesCursorToOldSize() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        long originalSize = buffer.size();
    ...
    @Test
    public void resizeShrinkMovesCursorToEnd() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
    ...
    @Test
    public void acquireReadOnlyDoesNotCopySharedDataArray() throws Exception {
    ...
    @Test
    public void acquireReadWriteDoesNotCopyUnsharedDataArray() throws Exception {
        Buffer buffer = deepCopy(bufferFactory.newBuffer());
        assumeTrue(buffer.size() > 0);
    ...
    @Test
    public void acquireReadWriteCopiesSharedDataArray() throws Exception {
        Buffer buffer = deepCopy(bufferFactory.newBuffer());
        assumeTrue(buffer.size() > 0);
    ...
    @Test
    public void writeSharedSegments() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
     ...
     */
    @Test
    public void cursorReuse() throws Exception {
        UnsafeCursor cursor = new UnsafeCursor();
    ...
    @Test
    public void expandSameSegment() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        long originalSize = buffer.size();
    ...
    @Test
    public void expandNewSegment() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        long originalSize = buffer.size();
    ...
    @Test
    public void expandMovesOffsetToOldSize() throws Exception {
        Buffer buffer = bufferFactory.newBuffer();
        long originalSize = buffer.size();
