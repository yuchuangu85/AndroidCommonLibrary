...
public final class NioTest {
    ...
    @Test
    public void sourceIsOpen() throws Exception {
    ...
    @Test
    public void sinkIsOpen() throws Exception {
    ...
    @Test
    public void writableChannelNioFile() throws Exception {
    ...
    @Test
    public void writableChannelBuffer() throws Exception {
    ...
    @Test
    public void writableChannelBufferedSink() throws Exception {
        Buffer buffer = new Buffer();
    ...
    @Test
    public void readableChannelNioFile() throws Exception {
        File file = temporaryFolder.newFile();
    ...
    @Test
    public void readableChannelBuffer() throws Exception {
        Buffer buffer = new Buffer();
    ...
    @Test
    public void readableChannelBufferedSource() throws Exception {
        Buffer buffer = new Buffer();
