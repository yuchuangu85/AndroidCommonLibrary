...
public final class Utf8Test {
    ...
    @Test
    public void doubleLowSurrogate() throws Exception {
        assertStringEncoded("3f3f", "\udc00\udc00"); // "??"
    }

    @Test
    public void doubleHighSurrogate() throws Exception {
        assertStringEncoded("3f3f", "\ud800\ud800"); // "??"
    }

    @Test
    public void highSurrogateLowSurrogate() throws Exception {
        assertStringEncoded("3f3f", "\udc00\ud800"); // "??"
    }
    ...
    @Test
    public void sizeWithBounds() throws Exception {
    ...
    @Test
    public void sizeBoundsCheck() throws Exception {
        try {
            Utf8.size(null, 0, 0);
            fail();
        } catch (IllegalArgumentException expected) {
