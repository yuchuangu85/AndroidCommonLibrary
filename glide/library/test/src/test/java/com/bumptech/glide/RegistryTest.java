...
public class RegistryTest {
    ...
    @Mock
    private ModelLoaderFactory<Model, Data> modelLoaderFactory;
    @Mock
    private ResourceDecoder<Data, ResourceOne> resourceOneDecoder;
    @Mock
    private ResourceDecoder<Data, ResourceTwo> resourceTwoDecoder;
    @Mock
    private ResourceTranscoder<ResourceOne, TranscodeOne> resourceOneTranscodeOneTranscoder;
