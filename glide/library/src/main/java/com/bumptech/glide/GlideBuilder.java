...
public final class GlideBuilder {
    ...
    /**
     * Sets the {@link GlideExecutor} to use when retrieving {@link com.bumptech.glide.load.engine.Resource}s
    ...
    /**
     * Sets the {@link GlideExecutor} to use when retrieving {@link com.bumptech.glide.load.engine.Resource}s
     * that are currently in Glide's disk caches.
     *
     * <p>Defaults to a single thread which is usually the best combination of memory usage, jank,
     * and performance, even on high end devices.
     *
    ...
    /**
     * Set to {@code true} to make Glide populate {@link com.bumptech.glide.load.engine.GlideException#setOrigin(Exception)}
     * for failed requests.
     *
