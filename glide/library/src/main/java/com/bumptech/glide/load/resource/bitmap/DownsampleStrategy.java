...
public abstract class DownsampleStrategy {
     ...
     * size.
     *
     * <p>This method will upscale if the requested width and height are greater than the source
     * width and height. To avoid upscaling, use {@link #AT_LEAST}, {@link #AT_MOST} or {@link
     * #CENTER_INSIDE}.
     *
     * <p>On pre-KitKat devices, {@code FIT_CENTER} will downsample by a power of two only so that
     * one of the image's dimensions is greater than or equal to the requested size. No guarantees are
