 ...
 * or a a fully implemented {@link Target} for any specialized use-cases. Using BaseView is unsafe
 * if the user does not implement {@link #onLoadCleared}, resulting in recycled bitmaps being
