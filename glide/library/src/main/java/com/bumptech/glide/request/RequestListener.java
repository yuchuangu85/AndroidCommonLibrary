...
public interface RequestListener<R> {
     ...
     *
     * <p>Although you can't start an entirely new load, it is safe to change what is displayed in
     * the {@link Target} at this point, as long as you return {@code true} from the method to prevent
     ...
     *                        into the target. For example when loading a thumbnail and a full-sized
     *                        image, this will be {@code true} for the first image to load and {@code
