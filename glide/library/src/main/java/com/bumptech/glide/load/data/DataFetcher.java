 ...
 * be called. If {@link #loadData(com.bumptech.glide.Priority, com.bumptech.glide.load.data.DataFetcher.DataCallback)}}
 * is called, then so {@link #cleanup()} will be called.
 *
...
public interface DataFetcher<T> {
     ...
     * since this method will be called from a thread in a {@link java.util.concurrent.ExecutorService}
     * that may have more than one background thread. You
