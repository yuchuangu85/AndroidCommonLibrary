 ...
 * {@link android.view.View View} using {@link android.view.View#startAnimation(android.view.animation.Animation)}.
 *
...
public class ViewTransition<R> implements Transition<R> {
     ...
     * then starts the {@link android.view.animation.Animation} given in the constructor using {@link
