...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
     ...
     *                      only wait for a pending layout pass if it's unable to resolve the size
     *                      from layout parameters or an existing View size. Because setting this
     *                      parameter to {@code true} forces Glide to wait for the layout pass to
     *                      occur before starting the load, setting this parameter to {@code true} can
     *                      cause flashing in some cases and should be used sparingly. If layout
     *                      parameters are set to fixed sizes, they will still be used instead of the
     *                      View's dimensions even if this parameter is set to {@code true}. This
