 ...
 *
 * <p>Exposes the specific status code or {@link #UNKNOWN} via {@link #getStatusCode()} so users
 * may attempt to retry or otherwise uniformly handle certain types of errors regardless of the
