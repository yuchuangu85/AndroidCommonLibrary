...
public abstract class TransitionOptions<
    ...
    /**
     * Uses the given {@link TransitionFactory} to build a {@link com.bumptech.glide.request.transition.Transition}
     * for each request started with these {@code TransitionOptions}.
     *
     * @return This request builder.
     */
    @NonNull
