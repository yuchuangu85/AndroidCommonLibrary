 ...
 *
 * <p>The smaller the resource you fetch, the less bandwidth and battery life you use, and the
 * lower your memory footprint per resource.
 *
 * @param <Model> The type of the model.
 * @param <Data>  The type of the data that can be used by a {@link com.bumptech.glide.load.ResourceDecoder}
 *                to decode a resource.
 */
public interface ModelLoader<Model, Data> {

    /**
     * Contains a set of {@link com.bumptech.glide.load.Key Keys} identifying the source of the load,
     * alternate cache keys pointing to equivalent data, and a {@link com.bumptech.glide.load.data.DataFetcher}
     * that can be used to fetch data not found in cache.
     *
