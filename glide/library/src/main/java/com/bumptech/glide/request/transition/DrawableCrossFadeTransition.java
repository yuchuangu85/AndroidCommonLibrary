...
public class DrawableCrossFadeTransition implements Transition<Drawable> {
    ...
    /**
     * @param duration           The duration that the cross fade animation should run if there is
     *                           something to cross fade from when a new {@link android.graphics.drawable.Drawable}
     *                           is put.
     ...
     *                           alpha at 100. See {@link TransitionDrawable#setCrossFadeEnabled(boolean)}.
     */
    // Public API.
