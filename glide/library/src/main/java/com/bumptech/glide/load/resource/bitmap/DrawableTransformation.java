 ...
 * exception if the requested size is {@link com.bumptech.glide.request.target.Target#SIZE_ORIGINAL}.
 * {@link Drawable}s without intrinsic dimensions are drawn using the dimensions provided in {@link
 * Transformation#transform(Context, Resource, int, int)}. As a result, they may be transformed
 * incorrectly or in unexpected ways.
 */
