...
public abstract class DiskCacheStrategy {
     ...
     * com.bumptech.glide.load.data.DataFetcher} and the {@link com.bumptech.glide.load.EncodeStrategy}
     * of the {@link com.bumptech.glide.load.ResourceEncoder} (if an {@link
     * com.bumptech.glide.load.ResourceEncoder} is available).
     */
     ...
     * @param encodeStrategy          The {@link EncodeStrategy} the {@link com.bumptech.glide.load.ResourceEncoder}
     *                                will use to encode the resource.
     */
