...
public interface Target<R> extends LifecycleListener {
     ...
     *
     * <p>You <b>must</b> ensure that any current Drawable received in {@link
     * #onResourceReady(Object, Transition)} is no longer used before redrawing the container (usually
     * a View) or changing its visibility.
     *
