 ...
 * and the {@link android.graphics.Bitmap.Config} returned from {@link
 ...
 * the performance of applications. This class works around #301 by only allowing re-use of {@link
