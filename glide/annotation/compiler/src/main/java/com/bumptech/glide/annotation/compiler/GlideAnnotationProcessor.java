 ...
 * com.bumptech.glide.GeneratedAppGlideModule}) that calls all {@code LibraryGlideModule}s and the
 * original {@code AppGlideModule} in the correct order when Glide is initialized.
 ...
 * static versions of all builder methods in the base class and both static and instance versions of
 * methods in all {@link com.bumptech.glide.annotation.GlideExtension}s.
 * <li>If one or more methods in one or more {@link
 * com.bumptech.glide.annotation.GlideExtension} annotated classes are annotated with {@link
 * GlideType}:
 * <ul>
 ...
 * <li>A {@code
 * com.bumptech.glide.manager.RequestManagerRetriever.RequestManagerFactory} implementation that
 * produces the generated {@code com.bumptech.glide.RequestManager}s.
 * <li>A {@code com.bumptech.glide.Glide} look-alike that implements all static
 * methods in the {@code com.bumptech.glide.Glide} singleton and returns the generated {@code
...
public final class GlideAnnotationProcessor extends AbstractProcessor {
     ...
     * {@code GeneratedAppGlideModule}. Once the {@code GeneratedAppGlideModule} is written, we expect
     * to be finished. Any further generation of related classes will result in errors.
     * </ol>
     */
    @Override
