 ...
 * com.bumptech.glide.request.RequestOptions#autoClone()} or {@code com.bumptech.glide.request.RequestOptions#lock()}
 ...
 * com.bumptech.glide.request.RequestOptions#clone()} or {@code com.bumptech.glide.request.RequestOptions#autoClone()}
 * can result in options applied in the method being silently ignored. Prefer the new style whenever
 * possible.
 *
 * <pre>{@code
