...
public class GifHeaderParser {
     ...
     * in the Transparent Index field.</i></p> Possible values are:<ul>
     ...
     * An image is interlaced in a four-pass interlace pattern.</i></p> Possible values are:<ul>
     ...
     * field is used to calculate the number of bytes contained in the Local Color Table. To determine
     * that actual size of the color table, raise 2 to [the value of the field + 1]. This value should
     * be 0 if there is no Local Color Table specified.</i></p>
     */
     ...
     * immediately following this Image Descriptor.</i></p> Possible values are:<ul>
     ...
     * field is used to calculate the number of bytes contained in the Global Color Table. To
     * determine that actual size of the color table, raise 2 to [the value of the field + 1]. Even if
     * there is no Global Color Table specified, set this field according to the above formula so that
     * decoders can choose the best graphics mode to display the stream in.</i></p>
     */
