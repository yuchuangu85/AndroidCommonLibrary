...
/**
 * An activity that demonstrates loading photos using {@link com.bumptech.glide.load.data.StreamLocalUriFetcher
 * content uris} through Glide. It works by making the user to choose a contact when presses a
 * button, and after he chooses a contact with photo, We try to load both a high res image and
